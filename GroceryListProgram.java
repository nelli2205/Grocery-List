...
public class GroceryListProgram {
        ...
        while (addedLastItem) {
            ...
            switch (userChoice) {
                case 1:
                    ...
                    GroceryItemOrder newItems = new GroceryItemOrder(name, quantity, pricePerUnit);

                    addedLastItem = items.add(newItems);
                    if (addedLastItem == false) {
                        System.out.println(
                                "We couldn't add that last item because your list is out of space. The program will now exit");

                        System.out.println("List of items:\n" + items);
                        System.out.println("Total cost: " + items.getTotalCost());
    ...
    public static void testClasses() {
        ...
        // + " TESTS FAILED!\nIn the transcript above look for the phrase TEST FAILED to
        // find the code that isn't doing what it's expected to do\n");
    }
}
